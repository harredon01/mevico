...
@Component({
  selector: 'app-mercado-pago-pse',
  templateUrl: './mercado-pago-pse.page.html',
  styleUrls: ['./mercado-pago-pse.page.scss'],
})
export class MercadoPagoPsePage implements OnInit {
    paymentMethod: any;
    year: any;
    month: any;
    payment: Payment;
